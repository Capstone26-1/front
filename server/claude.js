...
- hasInfeasibleLegs: true →
  ...
  5. latestSafeDeparture가 null이 아니면 recommendations에 반드시 포함: "HH:MM 이전에 출발하면 지하철만으로 [목적지]까지 도달 가능합니다."
...
<RESULT>
{
  ...
  "result": {
    ...
    "latestSafeDeparture": null
  }
}
</RESULT>

validate_transit_route 결과 hasInfeasibleLegs: true인 경우, result.latestSafeDeparture에 validate_transit_route가 반환한 latestSafeDeparture 값(HH:MM 문자열)을 그대로 설정하세요. null이면 null.
